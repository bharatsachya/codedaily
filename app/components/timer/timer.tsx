...
useEffect(() => {
    ...
    return<>
      {showTime ? (<div className='flex items-center ml-2 space-x-2 p-1.5 cursor-pointer rounded hover:bg-gray-800'>
        <div >
        {formatTime(time)}
        </div>
        ...
        <div className='flex items-center p-1 ml-2 mr-2 h-8 rounded cursor-pointer hover:text-black' onClick={handleClockClick}>
            <svg
